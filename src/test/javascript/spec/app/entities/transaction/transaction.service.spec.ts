...
describe('Service Tests', () => {
  describe('Transaction Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Transaction('ID', 'AAAAAAA', 0, 0, TransType.DEPOSIT, 'AAAAAAA', 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            transDate: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
